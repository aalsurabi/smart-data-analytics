...
test('test', async ({ page }) => {
  ...
  await page.getByText('Bericht Exportieren', { exact: true }).click();
  await page.screenshot({ path: 'generated_screenshots/few_shot/26_4.png' });
  const htmlContent = await page.content();
  writeFileSync('generated_html/few_shot/26_4.html', htmlContent);
